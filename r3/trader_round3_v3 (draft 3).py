...
class Trader:
    ...
    RISK_CAPS = {"VEV_4000":4,"VEV_4500":4,"VEV_5000":1,"VEV_5100":5,"VEV_5200":1,"VEV_5300":6,"VEV_5400":2,"VEV_5500":2,"VEV_6000":1,"VEV_6500":1}
    TTE = 5.0 / 365.0
    ...
    def run(self, state: TradingState):
        ...
        if hyd:
            ...
            self.quote('HYDROGEL_PACK', hyd, fair, pos, orders, halfspread=8, size=10)
        ...
        if ex_mid is not None:
            ...
            for sym, k in self.STRIKES.items():
                ...
                if ex_mid - k >= 700:
                    ...
                    edge = 2.8 if sym in ('VEV_5000','VEV_5100','VEV_5200') else 2.0
                    psize = 0 if sym in ('VEV_5000','VEV_5100','VEV_5200','VEV_5300') else 0
        ...
        if exd and ex_mid is not None:
            ...
            target_extract = max(-60, min(60, int(round(target_extract))))
            ...
            self.quote('VELVETFRUIT_EXTRACT', exd, fair, pos, orders, halfspread=3, size=5)
