...
class Trader:
    ...
    RISK_CAPS = {"VEV_4000":2,"VEV_4500":2,"VEV_5000":1,"VEV_5100":1,"VEV_5200":1,"VEV_5300":1,"VEV_5400":1,"VEV_5500":1,"VEV_6000":0,"VEV_6500":0}
    TTE = 5.0 / 365.0
    ...
    def run(self, state: TradingState):
        ...
        if ex_mid is not None:
            ...
            for sym, k in self.STRIKES.items():
                ...
                if ex_mid - k >= 700:
                    ...
                    edge = 3.0 if sym in ('VEV_5000','VEV_5100','VEV_5200','VEV_5300','VEV_5400') else 2.2
                    psize = 0
        ...
        if exd and ex_mid is not None:
            ...
            target_extract = max(-40, min(40, int(round(target_extract))))
            ...
            self.quote('VELVETFRUIT_EXTRACT', exd, fair, pos, orders, halfspread=4, size=4)
