...
![Algo.png](Game%20Mechanics%20Overview/Algo.png)
...
![Your Mission Control dashboard](Game%20Mechanics%20Overview/Prosperity4_DASHBOARD.png)
...
![The Algorithmic Challenge Overview](Game%20Mechanics%20Overview/Prosperity4_ALGORITHMIC_CHALLENGE_OVERVIEW.png)

The Algorithmic Challenge Overview
...
![The Upload & Changelog window](Game%20Mechanics%20Overview/Prosperity4_ALGORITHM_UPLOAD_LOG.png)
...
![The Mission Control dashboard](Game%20Mechanics%20Overview/Prosperity4_MANUAL_CHALLENGE_OVERVIEW.png)
...
![A.R.I.A. Uplinks are available from your Mission Control dashboard](Game%20Mechanics%20Overview/Prosperity4_DASHBOARD.png)

A.R.I.A. Uplinks are available from your Mission Control dashboard

![A.R.I.A. Uplink videos provide all the essential information per round](Game%20Mechanics%20Overview/Prosperity4_ARIA_UPLINK.png)

A.R.I.A. Uplink videos provide all the essential information per round
...
![The Outpost View provides an overview of your outpost](Game%20Mechanics%20Overview/Prosperity4_OUTPOST_VIEW.png)

The Outpost View provides an overview of your outpost
...
![The Leaderboard shows the ranking of all competing teams](Game%20Mechanics%20Overview/Prosperity4_LEADERBOARD.png)

The Leaderboard shows the ranking of all competing teams
...
![The Crew Honors page shows all the badges your team collected (and the ones that you can still collect)](Game%20Mechanics%20Overview/Prosperity4_CREW_HONORS.png)

The Crew Honors page shows all the badges your team collected (and the ones that you can still collect)
...
![Your On-Board Advisor is available at the bottom right of your Outpost View](Game%20Mechanics%20Overview/Prosperity4_OUTPOST_VIEW_WITH_OBA.png)

Your On-Board Advisor is available at the bottom right of your Outpost View