...
[Wiki_ROUND_2_data.zip](Round%202%20-%20%E2%80%9CGrowing%20Your%20Outpost%E2%80%9D/Wiki_ROUND_2_data.zip)
...
- Median is computed from submitted [trader.py](http://trader.py/) files - if no bid(), we consider it 0; we neglect the teams with no [trader.py](http://trader.py/) submission for the purposes of median()
