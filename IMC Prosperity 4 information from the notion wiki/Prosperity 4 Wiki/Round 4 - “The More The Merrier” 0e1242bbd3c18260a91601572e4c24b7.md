...
In the datamodel described in [Appendix B: datamodel.py file in 💻 **Writing an Algorithm in Python**](Writing%20an%20Algorithm%20in%20Python%20856242bbd3c18358a65781d950208c33.md), you will find the `Trade` class defined. For previous rounds 1,2,3, the `self.buyer` and `self.seller` fields were always `None` as no counterparty information was available.
